...
massive.munit.client.HTTPClient = function(client,url,queueRequest) {
	...
	this.id = "HTTPClient";
	this.client = client;
	if(url == null) this.url = massive.munit.client.HTTPClient.get_DEFAULT_SERVER_URL(); else this.url = url;
...
massive.munit.client.HTTPClient.get_DEFAULT_SERVER_URL = function() {
	if(massive.munit.client.HTTPClient.hostStr == null) {
		massive.munit.client.HTTPClient.hostStr = window.location.host;
