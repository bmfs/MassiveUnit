...
BrowserTestsCompleteReporter.sendReport = function(onData,onError) {
	var httpRequest = new haxe_Http(massive_munit_client_HTTPClient.get_DEFAULT_SERVER_URL());
...
var massive_munit_client_HTTPClient = function(client,url,queueRequest) {
	...
	this.id = "HTTPClient";
	this.client = client;
	if(url == null) this.url = massive_munit_client_HTTPClient.get_DEFAULT_SERVER_URL(); else this.url = url;
...
massive_munit_client_HTTPClient.get_DEFAULT_SERVER_URL = function() {
	if(massive_munit_client_HTTPClient.hostStr == null) {
		massive_munit_client_HTTPClient.hostStr = window.location.host;
		massive_munit_client_HTTPClient.hostStr = "http://" + massive_munit_client_HTTPClient.hostStr;
	}
	return massive_munit_client_HTTPClient.hostStr;
};
